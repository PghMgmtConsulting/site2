// Navigation 1 - Updated February 10, 2024
function noop() { }
const identity = x => x;
...
function create_each_block_1(ctx) {
	...
	return {
		...
		h() {
			attr(a, "class", "link svelte-1hmbaay");
...
function create_if_block(ctx) {
	...
	return {
		...
		h() {
			...
			attr(button, "class", "svelte-1hmbaay");
			attr(nav, "id", "popup");
			attr(nav, "class", "svelte-1hmbaay");
		},
		m(target, anchor) {
...
function create_fragment(ctx) {
	...
	return {
		...
		h() {
			attr(a0, "href", "/");
			attr(a0, "class", "logo svelte-1hmbaay");
			attr(nav, "class", "svelte-1hmbaay");
			attr(div0, "class", "desktop-nav svelte-1hmbaay");
			attr(a1, "href", "/");
			attr(a1, "class", "logo svelte-1hmbaay");
			attr(button, "id", "open");
			attr(button, "aria-label", "Open mobile navigation");
			attr(div1, "class", "mobile-nav svelte-1hmbaay");
			attr(header, "class", "section-container svelte-1hmbaay");
		},
		m(target, anchor) {
