// Social Links - Updated February 14, 2024
function noop() { }
...
function create_if_block(ctx) {
	...
	return {
		...
		h() {
			attr(a, "class", "link svelte-oyp6gf");
...
function create_each_block(ctx) {
	...
	return {
		...
		h() {
			...
			attr(a, "class", "svelte-oyp6gf");
			attr(li, "class", "svelte-oyp6gf");
		},
		m(target, anchor) {
...
function create_fragment(ctx) {
	...
	return {
		...
		h() {
			attr(h2, "class", "heading svelte-oyp6gf");
			attr(ul, "class", "svelte-oyp6gf");
			attr(div, "class", "card svelte-oyp6gf");
			attr(section, "class", "section-container svelte-oyp6gf");
		},
		m(target, anchor) {
