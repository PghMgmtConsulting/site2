...
function create_fragment(ctx) {
	...
	return {
		...
		l(nodes) {
			...
			h1 = claim_element(footer_nodes, "H1", {});
			var h1_nodes = children(h1);
			t0 = claim_text(h1_nodes, name);
		...
		h() {
			attr(div, "class", "social-links svelte-9zvfby");
			attr(footer, "class", "section-container svelte-9zvfby");
		},
		m(target, anchor) {
			insert_hydration(target, footer, anchor);
			append_hydration(footer, h1);
