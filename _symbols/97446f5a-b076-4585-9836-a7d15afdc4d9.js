// Navigation 1 (copy) - Updated February 8, 2024
function noop() { }
const identity = x => x;
...
function create_if_block(ctx) {
	...
	return {
		...
		h() {
			...
			attr(button, "class", "svelte-1j000gj");
			attr(nav, "id", "popup");
			attr(nav, "class", "svelte-1j000gj");
		},
		m(target, anchor) {
