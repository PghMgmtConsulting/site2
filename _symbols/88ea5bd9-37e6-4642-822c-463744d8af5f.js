// Contact Form - Updated December 23, 2024
function noop() { }
function run(fn) {
    return fn();
}
...
function create_fragment(ctx) {
	...
	return {
		...
		h() {
			...
			attr(div1, "class", "body svelte-x51ao3");
			attr(section, "class", "section-container svelte-x51ao3");
		},
		m(target, anchor) {
...
function instance($$self, $$props, $$invalidate) {
	...
	return [heading, subheading, props, inputs, social];
}
