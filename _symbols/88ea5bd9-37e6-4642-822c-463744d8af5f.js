// Contact Form - Updated February 14, 2024
function noop() { }
function run(fn) {
    return fn();
}
...
// (91:6) {#each social as { label, link }}
function create_each_block_1(ctx) {
	...
	return {
		...
		h() {
			attr(span, "class", "label svelte-clvupk");
			attr(a, "href", a_href_value = /*link*/ ctx[9].url);
			attr(a, "class", "svelte-clvupk");
			attr(div, "class", "item svelte-clvupk");
		},
		m(target, anchor) {
...
function create_else_block(ctx) {
	...
	return {
		...
		h() {
			...
			attr(input, "class", "svelte-clvupk");
			attr(label, "class", "svelte-clvupk");
		},
		m(target, anchor) {
...
function create_if_block(ctx) {
	...
	return {
		...
		h() {
			...
			attr(textarea, "class", "svelte-clvupk");
			attr(label, "class", "svelte-clvupk");
		},
		m(target, anchor) {
			insert_hydration(target, label, anchor);
...
function create_fragment(ctx) {
	...
	return {
		...
		h() {
			...
			attr(div1, "class", "social-links svelte-clvupk");
			attr(div2, "class", "body svelte-clvupk");
			attr(button, "class", "button svelte-clvupk");
			attr(button, "type", "submit");
			attr(form, "class", "svelte-clvupk");
			attr(section, "class", "section-container svelte-clvupk");
		},
		m(target, anchor) {
