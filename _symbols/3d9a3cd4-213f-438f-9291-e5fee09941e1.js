// Site Footer 1 - Updated December 23, 2024
function noop() { }
...
function create_each_block(ctx) {
	...
	return {
		...
		p(ctx, dirty) {
			...
			if (!current || dirty & /*social*/ 1 && a_aria_label_value !== (a_aria_label_value = /*link*/ ctx[3].label)) {
...
function create_fragment(ctx) {
	...
	return {
		c() {
			...
			h2 = element("h2");
			t0 = text("Pittsburgh Management Consulting\n  ");
			div0 = element("div");
		...
		l(nodes) {
			...
			h2 = claim_element(footer_nodes, "H2", { class: true });
			var h2_nodes = children(h2);
			t0 = claim_text(h2_nodes, "Pittsburgh Management Consulting\n  ");
			div0 = claim_element(h2_nodes, "DIV", {});
			var div0_nodes = children(div0);
			t1 = claim_text(div0_nodes, "3950 Roberto Clemente Ave");
		...
		m(target, anchor) {
			...
			append_hydration(footer, h2);
			append_hydration(h2, t0);
			append_hydration(h2, div0);
...
function instance($$self, $$props, $$invalidate) {
	...
	return [social, props, nav];
}

class Component extends SvelteComponent {
	constructor(options) {
		super();
		init(this, options, instance, create_fragment, safe_not_equal, { props: 1, nav: 2, social: 0 });
	}
}
